...
namespace Webapp.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        {
            var payments = db.Payments.Include(p => p.ApplicationUser).Include(p => p.Customer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CustomerId,ApplicationUserId,TotalAmount,PaymentDate")] Payment payment)
        {
            if (ModelState.IsValid)
            {
